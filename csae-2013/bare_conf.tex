...
\begin{abstract}
%\boldmath
Concurrent programming has always been difficult work for it's not as intuitional as sequential
programming, and there are too many subtle details to deal with. In this paper we 
design a high-level abstraction for data-flow drived concurrent programming using the functional
programming language Haskell. The abstraction provides a very clean, elegent and powerful
programming interface to the programmers so as to simplify the work of concurrent programming.
Our abstract interface make programs coded like sequential ones but scheduled concurrently,
and it works well with exceptions.
\end{abstract}
